        ...
        <div class="card card-outline-secondary">
            ...
            <div class="card-body">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label" for="radio1">
                                    <input type="radio" class="form-check-input" id="radio1" name="optradio"
                                           value="{{url('/admin/resource/create/classroom')}}">Salas
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label" for="radio2">
                                    <input type="radio" class="form-check-input" id="radio2" name="optradio"
                                           value="{{url('/admin/resource/create/instrument')}}" checked>Instrumento
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <form id="search_resource" class="form" role="form" method="POST"
                      action="{{ url('/admin/resource/create/instrument') }}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
