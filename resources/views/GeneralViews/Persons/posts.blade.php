...
@section('content')
    <div class="container result">
        ...
        <div class="row d-flex justify-content-center" style="margin-top: 50px;">
            <div class="col-lg-3">
                <button class="btn btn-dark btn-lg" type="button" data-toggle="modal" data-target=".bd-example-modal-lg">Ver publicación</button>
            </div>
            <div class="col-lg-3">
                <button class="btn btn-dark btn-lg" type="button" data-toggle="modal" data-target="#deleteModal">Eliminar</button>
            </div>
        </div>
        <!-- Modal -->
                    ...
                    <div class="modal-body">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4 d-flex justify-content-end">
                                <img src="{{asset('/img/andres.PNG')}}" alt="Generic placeholder image" class="w-25 rounded-circle">
                                <br><h4 class="d-flex align-items-center ml-4">Andrés Cocunubo</h4>
                            </div>
                        </div>
                        <hr>
                        <div class="container details">
                            <p><span class="fa fa-file-text" style="width:50px;"></span> Concierto procede del verbo concertar (componer, ordenar, ajustar).
                                Puede tratarse del convenio entre dos o más personas o entidades sobre algún asunto: “La intención del gobierno es llegar a un
