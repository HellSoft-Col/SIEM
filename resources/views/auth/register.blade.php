                    ...
                    <div class="container">
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="carreer_id"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Carrera') }}</label>

                                    <div class="col-md-6">
                                        <select id="carreer_id"
                                                class="form-control{{ $errors->has('carreer_id') ? ' is-invalid' : '' }}"
                                                name="carreer_id" required autofocus>
                                        ...
                                        @if ($errors->has('carreer_id'))
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('carreer_id') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                </div>
